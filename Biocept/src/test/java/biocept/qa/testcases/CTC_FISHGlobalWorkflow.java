...
// test = extent.createTest("Verify user is able to login in LIMS portal",
// "User should be able to login in LIMS portal with valid credentials.");
...
// }
//
// @Test(priority = 2, dependsOnMethods = { "LIMSLogin" }, description = "Verify
// the total link count on dashboard ")
// public void dashboard() throws InterruptedException {
// test = extent.createTest("Verify the total link count on dashboard",
// "Total link in LIMS dashboard should be 6.");
...
// "LIMSLogin" }, description = "Verify user is able to create a new accession
// for CTC-FISH")
// public void PlaceNewOrder() throws InterruptedException {
// test = extent.createTest("Verify user is able to create a new accession for
// CTC-FISH",
// "User should be able to create a acession with CTC-FISH test.");
...
// }
//
// @Test(priority = 4, dependsOnMethods = { "PlaceNewOrder" }, description =
// "Verify patient name on barcode page")
// public void PatientNameOnBarcodePage() throws InterruptedException {
// test = extent.createTest("Verify patient name on barcode page",
// "Patient name on barcode page should be same as we enter while
// accessioning.");
...
// "PlaceNewOrder" }, description = "Verify user is able to upload the CTC/FISH
// images")
// public void UploadAccessionImagesPageTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to upload the CTC/FISH images",
// "User should be able to upload CTC/FISH images from Upload Accession Images
// page.");
...
// "PlaceNewOrder" }, description = "Verify user is able to open the My
// Worklist")
// public void MyWorklistTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the My Worklist",
// "User should be able to open the MY worklist from left menu.");
...
// "MyWorklistTitle" }, description = "Verify the accession type when user
// create an accession without selecting Assign Professional Work checkbox")
// public void AccesstionType() throws InterruptedException {
// test = extent.createTest(
// "Verify the accession type when user create an accession without selecting
// Assign Professional Work checkbox",
// "Accession type should be Global.");
// test.assignCategory("My Worklist");
// explicitWait.invisibilityOfLoader();
...
// "AccesstionType" }, description = "Verify user is able to open the Cell Cep
// Processing Activity")
// public void CellCepProcessingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Cell Cep Processing
// Activity",
// "User should be able to open the Cell Cep Processing Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "CellCepProcessingActivityTitle" }, description = "Verify user is able to
// complete the Cell Cep Processing Activity")
// public void CellCepProcessing() throws InterruptedException {
// test = extent.createTest("erify user is able to complete the Cell Cep
// Processing Activity",
// "User should be able to complete the Cell Cep Processing Activity after
// select Leucosep Tube value.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "CellCepProcessing" }, description = "Verify user is able to open the Cell
// Cep Batching Activity")
// public void CellSepBatchingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the cell Cep Batching
// Activity",
// "User should be able to open the Cell Cep Batching Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// "CellSepBatchingActivityTitle" }, description = "Verify user is able to
// complete the Cell Cep Batching Activity")
// public void CellSepBatching() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the Cell Cep
// Batching Activity",
// "User should be able to save and complete the Cell Cep Batching Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "CellSepBatching" }, description = "Verify user is able to open the Mems
// Processing Activity")
// public void MEMSProcessingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Mems Processing
// Activity",
// "User should be able to open the Mems Processing from MY worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
// explicitWait.invisibilityOfLoader();
...
// "MEMSProcessingActivityTitle" }, description = "Verify user is able to
// complete the Mems Processing Activity")
// public void MEMSProcessing() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the Mems Processing
// Activity",
// "User should be able to select the CTC/ICCtest and complete the Mems
// Processing Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "MEMSProcessing" }, description = "Verify user is able to open the Mems
// Batching Activity")
// public void MemsBatchingActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Mems Batching
// Activity",
// "User should be able to open the Mems Batching Activity from MY worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 15, dependsOnMethods = {
// "MemsBatchingActivityTitle" }, description = "Verify user is able to complete
// the Mems Batching Activity")
// public void MemsBatching() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the Mems Batching
// Activity",
// "User should be able to complete the Mems Batching Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 16, dependsOnMethods = {
// "MemsBatching" }, description = "Verify user is able to open the Bioview Scan
// Data Activity")
// public void BioviewScanDataActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Bioview Scan Data
// Activity",
// "User should be able to open the Bioview Scan Data Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// }
//
// @Test(priority = 17, dependsOnMethods = {
// "BioviewScanDataActivityTitle" }, description = "Verify user is able to
// complete the Bioview Scan Data Activity")
// public void BioviewScanData() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the Bioview Scan
// Data Activity",
// "User should be able to save and complete the Bioview Scan Data Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "BioviewScanData" }, description = "Verify user is able to open the
// Enumeration Image Review Activity")
// public void EnumerationImageReviewActivityTitle() throws InterruptedException
// {
// test = extent.createTest("Verify user is able to open the Enumeration Image
// Review Activity",
// "User should be able to open the Enumeration Image Review Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// "EnumerationImageReviewActivityTitle" }, description = "Verify user is able
// to complete the Enumeration Image Review Activity")
// public void EnumerationImageReview() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the Enumeration
// Image Review Activity",
// "User should be able to save and complete the Enumeration Image Review
// Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// "EnumerationImageReview" }, description = "Verify user is able to open the
// CTC ICC Results Summary Activity")
// public void CTCICCResultsSummaryActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the CTC ICC Results
// Summary Activity",
// "User should be able to open the CTC ICC Results Summary Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// }
//
// @Test(priority = 21, dependsOnMethods = {
// "CTCICCResultsSummaryActivityTitle" }, description = "Verify user is able to
// complete the CTC ICC Results Summary Activity")
// public void CTCICCResultsSummary() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the CTC ICC Results
// Summary Activity",
// "User should be able to save and complete the CTC ICC Results Summary
// Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 22, dependsOnMethods = {
// "CTCICCResultsSummary" }, description = "Verify user is able to open the FISH
// Auto batched worklist Activity")
// public void FISHAutobatchedworklistActivityTitle() throws
// InterruptedException {
// test = extent.createTest("Verify user is able to open the FISH Auto batched
// worklist Activity",
// "User should be able to open the FISH Auto batched worklist Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// }
//
// @Test(priority = 23, dependsOnMethods = {
// "FISHAutobatchedworklistActivityTitle" }, description = "Verify user is able
// to complete the FISH Auto batched worklist Activity")
// public void FISHAutobatchedworklist() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the FISH Auto
// batched worklist Activity",
// "User should be able to save and complete the FISH Auto batched worklist
// Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 24, dependsOnMethods = {
// "FISHAutobatchedworklist" }, description = "Verify user is able to open the
// FISH Relo Analysis Activity")
// public void FISHReloAnalysisActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the FISH Relo Analysis
// Activity",
// "User should be able to open the FISH Relo Analysis Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// }
//
// @Test(priority = 25, dependsOnMethods = {
// "FISHReloAnalysisActivityTitle" }, description = "Verify user is able to
// complete the FISH Relo Analysis Activity")
// public void FISHReloAnalysis() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the FISH Relo
// Analysis Activity",
// "User should be able to save and complete the FISH Relo Analysis Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 26, dependsOnMethods = {
// "FISHReloAnalysis" }, description = "Verify user is able to open the FISH
// Results Summary Activity")
// public void FISHResultsSummaryActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the FISH Results
// Summary Activity",
// "User should be able to open the FISH Results Summary Activity from MY
// worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
...
// }
//
// @Test(priority = 27, dependsOnMethods = {
// "FISHResultsSummaryActivityTitle" }, description = "Verify user is able to
// complete the FISH Results Summary Activity")
// public void FISHResultsSummary() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the FISH Results
// Summary Activity",
// "User should be able to save and complete the FISH Results Summary
// Activity.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 28, dependsOnMethods = {
// "FISHResultsSummary" }, description = "Verify user is able to open the
// TechOnly Professional Interpretation Activity")
// public void PIActivityTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the TechOnly
// Professional Interpretation Activity",
// "User should be able to open the TechOnly Professional Interpretation
// Activity from MY worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
// myWorklist.search(AccessionID, "CTC-FISH");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 29, dependsOnMethods = {
// "PIActivityTitle" }, description = "Verify user is able to complete the PI
// Activity")
...
// }
//
// @Test(priority = 30, dependsOnMethods = {
// "TechOnlyProfessionalInterpretation" }, description = "Verify user is able to
// open the QA Reporting Worklist")
// public void QAReportingWorklistTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the QA Reporting
// Worklist",
// "User should be able to open the QA Reporting Worklis from Left Menu.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 31, dependsOnMethods = {
// "QAReportingWorklistTitle" }, description = "Verify user is able to complete
// the QA Reporting")
// public void QAReportingWorklist() throws InterruptedException {
// test = extent.createTest("Verify user is able to complete the QA Reporting",
// "User should be able to do QA reporting for particular record.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// Assert.assertEquals(ActivityCompleteMessage, "QA Reporting has been
// completed");
// }
//
// @Test(priority = 32, dependsOnMethods = {
// "QAReportingWorklist" }, description = "Verify user is able to open FISH
// Review & Approve Worklist")
// public void FishReviewApproveWorklistTitle() throws InterruptedException {
// test = extent.createTest("Verify user is able to open FISH Review & Approve
// Worklist",
// "User should be able to open the FISH Review & Approve from Left Menu.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// @Test(priority = 33, dependsOnMethods = {
// "FishReviewApproveWorklistTitle" }, description = "Verify user is able to
// Signoff the CTC-FISH Report from FISH Review & Approve Worklist")
// public void FishReportSignoff() throws InterruptedException {
// test = extent.createTest(
// "Verify user is able to Signoff the CTC-FISH Report from FISH Review &
// Approve Worklist",
// "User should be able to Signoff the CTC-FISH Report from FISH Review &
// Approve Worklist.");
// test.assignCategory("CTC-FISH Workflow for Global cases");
// explicitWait.invisibilityOfLoader();
...
// }
//
// // @Test(priority= 39, description="Verify user is able to open FISH Review
// // & Approve Worklist")
// // public void FISHReviewApproveTitle() throws InterruptedException{
// // test=extent.createTest("Verify user is able to open FISH Review & Approve
// // Worklist", "User should be able to open the FISH Review & Approve from
// // Left Menu.");
// // test.assignCategory("CTC-FISH Workflow for Global cases");
// // explicitWait.invisibilityOfLoader();
// // leftMenuItems.leftMenuSelection("FISH Review & App","Individual");
...
// // }
// //
// // @Test(priority= 40, description="Verify user is able to Signoff the
// // CTC-FISH Report from FISH Review & Approve Worklist")
// // public void FISHReportSignoff() throws InterruptedException{
// // test=extent.createTest("Verify user is able to Signoff the CTC-FISH
// // Report from FISH Review & Approve Worklist", "User should be able to
// // Signoff the CTC-FISH Report from FISH Review & Approve Worklist.");
// // test.assignCategory("CTC-FISH Workflow for Global cases");
// // explicitWait.invisibilityOfLoader();
// // fishReviewAndApproveWorklist.search(AccessionID, "CTC-FISH");
...
// //////////////////
//
// @Test(priority = 34, dependsOnMethods = {
// "FishReportSignoff" }, description = "Verify user is able to open the
// Completed Worklist")
// public void CompletedWorklist() throws InterruptedException {
// test = extent.createTest("Verify user is able to open the Completed
// Worklist",
// "User should be able to open the Completed Worklist from left menu.");
...
// "CompletedWorklist" }, description = "Verify the functionality when user
// tries to reopen the case from completed worklist")
// public void ConfirmationPopupOnCompletedWorklist() throws
// InterruptedException {
// test = extent.createTest("Verify the functionality when user tries to reopen
// the case from completed worklist",
// "A confirmation popup for reopening the case should be open.");
// test.assignCategory("Completed Worklist");
// explicitWait.invisibilityOfLoader();
...
// "Are you sure, you want to reopen this report? This will require a new report
// to be created and issued.");
// }
//
// @Test(priority = 36, dependsOnMethods = {
// "ConfirmationPopupOnCompletedWorklist" }, description = "Verify the activity
// after reopen the case from completed worklist")
// public void ActivityTitleAfterReOpen() throws InterruptedException {
// test = extent.createTest("Verify the activity after reopen the case from
// completed worklist",
// "TechOnly Professional Interpretation page should be open.");
// test.assignCategory("Completed Worklist");
...
// }
//
// // @Test(priority= 37,dependsOnMethods = { "ActivityTitleAfterReOpen"},
// // description="Verify user is able to open FISH Review & Approve Worklist")
// // public void FishReviewApproveTitle() throws InterruptedException{
// // test=extent.createTest("Verify user is able to open FISH Review & Approve
// // Worklist", "User should be able to open the FISH Review & Approve from
// // Left Menu.");
...
// "ActivityTitleAfterReOpen" }, description = "Verify the functionality when
// user tries to signoff the report again")
// public void ReportVersionSelectionPopUp() throws InterruptedException {
// test = extent.createTest("Verify the functionality when user tries to signoff
// the report again",
// "A popup should be open to select the report version.");
...
// fishReviewAndApproveWorklist.reportSignoff();
// String PopupTitle =
// fishReviewAndApproveWorklist.reportVersionSelectionPopup();
// Assert.assertEquals(PopupTitle, "Report Version Selection");
// }
//
// @Test(priority = 39, dependsOnMethods = {
// "ReportVersionSelectionPopUp" }, description = "Verify user is able to create
// a new version of report")
// public void SignoffTheReportForNewVersion() throws InterruptedException {
// test = extent.createTest("Verify user is able to create a new version of
// report",
// "user should be able to signoff the report after select the Version Type and
// entering the reason.");
// test.assignCategory("Report Versioning");
...
// "PlaceNewOrder" }, description = "Verify user is able to download CTC-FISH
// Summary Report")
// public void CTC_FISH_SummaryReport() throws InterruptedException {
// test = extent.createTest("Verify user is able to download CTC-FISH Summary
// Report",
// "CTC-FISH Summary Report file should be downloaded after click on CTC-FISH
...
// }
//
// @Test(priority = 41, dependsOnMethods = {
// "PlaceNewOrder" }, description = "Verify user is able to download CTC-FISH
// Score Sheet")
// public void CTC_FISH_ScoreSheet() throws InterruptedException {
// test = extent.createTest("Verify user is able to download CTC-FISH Score
// Sheet",
// "CTC-FISH Score Sheet file should be downloaded after click on CTC-FISH Score
// Sheet button.");
// test.assignCategory("Barcode Page");
...
// test = extent.createTest("Verify user is able to download CTC-FISH Sample
// Traveler",
// "CTC-FISH Sample Traveler file should be downloaded after click on CTC-FISH
// Sample Traveler button.");
// test.assignCategory("Barcode Page");
// boolean found = DownloadedFiles.verify("CTC-FISH_Sample_Traveler");
// Assert.assertEquals(found, true);
// }
//
// @Test(priority = 43, dependsOnMethods = {
// "PlaceNewOrder" }, description = "Verify user is able to download Generate
// Long Label(s)")
// public void GenerateLongLabel() throws InterruptedException {
// test = extent.createTest("Verify user is able to download Generate Long
// Label(s)",
// "Long Label(s) file should be downloaded after click on Generate Long
// Label(s) button.");
// test.assignCategory("Barcode Page");
...
// }
//
// @Test(priority = 44, dependsOnMethods = {
// "PlaceNewOrder" }, description = "Verify user is able to download Generate
// Small Label")
// public void GenerateSmallLabel() throws InterruptedException {
// test = extent.createTest("Verify user is able to download Generate Small
// Label",
// "Small Label file should be downloaded after click on Generate Small Label
// button.");
// test.assignCategory("Barcode Page");
// boolean found = DownloadedFiles.verify("Bar_" + AccessionID);
// Assert.assertEquals(found, true);
// }
//
// @Test(priority = 45, dependsOnMethods = {
// "PlaceNewOrder" }, description = "Verify user is able to download Generate
// Molecular Label")
// public void GenerateMolecularLabel() throws InterruptedException {
// test = extent.createTest("Verify user is able to download Generate Molecular
// Label",
// "Molecular Label file should be downloaded after click on Generate Molecular
// Label button.");
// test.assignCategory("Barcode Page");
// boolean found = DownloadedFiles.verify("Bar_" + AccessionID);
// Assert.assertEquals(found, true);
// }
//
// @Test(priority = 46, dependsOnMethods = {
// "MyWorklistTitle" }, description = "Verify the download functionality for
// PlasmaCSV")
// public void DownloadPlasmaCSV() throws InterruptedException {
// test = extent.createTest("Verify the download functionality for PlasmaCSV",
// "PlasmaCSV file should be downloaded after click on Plasma CSV button.");
// test.assignCategory("My Worklist");
...
// // //htmlReporter.config().setDocumentTitle("AutomationTesting.in Demo
// // Report");
